...
desiredCaps.name = 'UC000038 - Supervisor - Flexi Checkin and Checkout resides in dashboard';
...
driver
	...
	.fin(function() {
		...
		try {
			console.log('Usecase Executed : UC000038');
			return driver.quit();
		} catch (e) {
			console.log('Usecase failed : UC000038');
			console.log(e);
		}
	})
	.done();
