...
desiredCaps.name= 'UC000108 - LEADERSHIP - Work From Home with Owner Chat';
	...
	.then(async function (searchElement) {
	  ...
	  .then(async function () {
		return await driver.waitForElementByAccessibilityId(
			...
			'Bhuvanesh tech'+day_string+' '+month+' '+year, asserters.isDisplayed
			&& asserters.isEnabled, 4000);
	  })
	  .then(async function (searchElement) {
		return await searchElement.click();
	  ...
	  .fin(function() { 
		  ...
		  try {
				  console.log('Usecase Executed : UC000108');
				  return driver.quit();
			  } catch (e) {
				  console.log('Usecase failed : UC000108');
				  console.log(e);
			  }
	  })
	.done();
