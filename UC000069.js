...
desiredCaps.name= 'UC000069 - Employee - Add Leave and Supervisor Rejection';
...
driver
	...
	.then(async function() {
		...
		console.log('Leave type - Selection');
			...
			return await driver.waitForElementByXPath(
				...
				'//android.widget.TextView[@text="Casual or Sick Leave" or @text="Casual or Sick Leaves"]',
				asserters.isEnabled,
				25000
			);
		} catch (err) {}
	...
	.then(async function() {
		...
		else return await driver.waitForElementByAccessibilityId('Yogaraj M'+day_string+' '+month+' '+year, asserters.isEnabled, 4000);
	} catch (err) {}
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//android.widget.TextView[@text="Pending"]', asserters.isDisplayed 
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//android.widget.TextView[@text="Reject"]', asserters.isEnabled, 10000);
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	})
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//android.widget.TextView[@text="YES" or @text="Yes"]', asserters.isEnabled, 10000);
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	})
