...
desiredCaps.name= 'UC000106 - SUPERVISOR - Work From Home with Manager Chat';
	...
	.then(async function(searchElement) {
	  ...
	  .then(async function () {
		return await driver.waitForElementByAccessibilityId(
			...
			'Kumaravel Thangaraj'+day_string+' '+month+' '+year, asserters.isDisplayed
			&& asserters.isEnabled, 4000);
	  })
	  .then(async function (searchElement) {
		return await searchElement.click();
	  ...
	  .fin(function() { 
		  ...
		  try {
				  console.log('Usecase Executed : UC000106');
				  return driver.quit();
			  } catch (e) {
				  console.log('Usecase failed : UC000106');
				  console.log(e);
			  }
	  })
	.done();
