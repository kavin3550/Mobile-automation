...
desiredCaps = {
	...
	name: 'UC000066 - SUPERVISOR - Selfie Checkin',
...
driver
	...
	.then(async function() {
		await driver.execute(
			'browserstack_executor: {"action":"cameraImageInjection", "arguments": {"imageUrl" : "media://6a195747c28b1fc494700ba123af1aa807527711"}}'
		);
	})
	.then(async function() {
		if (desiredCaps.platformName == 'iOS' || desiredCaps.platformName == 'ios' || desiredCaps.platformName == 'IOS')
