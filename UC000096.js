...
desiredCaps = {
  ...
  'browserstack.key' : 'htCqd4CJdqdyqeCnosDP',
	...
	name: 'UC000096 - Supervisor - Payroll and Payslip',
...
driver
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//ancestor::*[*[@text="01 November 2021 - 30 November 2021"]]', asserters.isEnabled, 4000);
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	})
