...
desiredCaps = {
  ...
  'browserstack.key' : 'htCqd4CJdqdyqeCnosDP',
	...
	name: 'UC000093 - Supervisor - Add Deduction and Leadership Approval',
...
driver
	...
	.then(async function() {
		...
		//else return await driver.waitForElementByXPath('//android.view.ViewGroup[@content-desc="Kumaravel Thangaraj-Advance-31 March 2022"]', asserters.isEnabled, 15000);
	})
	.then(async function(searchElement) {
		// if(searchElement)
		// {
