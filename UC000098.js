...
desiredCaps = {
  ...
  'browserstack.key' : 'htCqd4CJdqdyqeCnosDP',
	...
	'app' : 'bs://24895d0fc720ba7cd5af66b5476d30d194a2509c',
	...
	name: 'UC000098 - Leadership - Payroll and Payslip',
	 platformName: 'ios'
};
...
driver
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//ancestor::*[*[@text="10 October 2021 - 31 October 2021"]]', asserters.isEnabled, 4000);
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	})
