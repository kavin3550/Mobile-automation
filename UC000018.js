...
desiredCaps.name = 'UC000018 - Supervisor - Checkin and Scan QR code';
...
// 	name: 'UC000018 - Supervisor - Checkin and Scan QR code',
...
driver
	...
	.fin(function() {
		...
		try {
			console.log('Usecase Executed : UC000018');
			return driver.quit();
		} catch (e) {
			console.log('Usecase failed : UC000018');
			console.log(e);
		}
	})
	.done();
