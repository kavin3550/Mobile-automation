...
desiredCaps = {
  ...
  'browserstack.key' : 'htCqd4CJdqdyqeCnosDP',
	...
	name: 'UC000094 - Supervisor - Add Deduction and Owner Approval',
...
driver
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//ancestor::*[*[@text="Payroll"]]', asserters.isEnabled, 10000);
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	})
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//ancestor::*[*[@text="My Deductions" or @text="My deductions"]]', asserters.isEnabled, 10000);
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	})
	...
	.then(async function() {
		...
		else return await driver.elementByXPathOrNull('//android.view.ViewGroup[@content-desc="ChooseDeductionType"]', 15000);
	...
	.then(async function() {
		...
		//else return await driver.waitForElementByAccessibilityId('Kumaravel Thangaraj-Advance-31 March 2022', asserters.isEnabled, 25000);
		else return await driver.waitForElementByXPath('//android.view.ViewGroup[@content-desc="Kumaravel Thangaraj-Advance-31 March 2022"]', asserters.isEnabled, 20000);
	})
	.then(async function(searchElement) {
		// if(searchElement)
		// {
