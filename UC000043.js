...
desiredCaps = {
  ...
  'app' : 'bs://d18adacfcecf7255564e67e65f5a8c38444f55a4',
...
// //   'app' : 'bs://d18adacfcecf7255564e67e65f5a8c38444f55a4',
// //   // Specify device and os_version for testing
// //   'device' : 'OnePlus OnePlus 9',
// //   'os_version' : '11.0',
// //  // Set other BrowserStack capabilities
// //  project: 'Manzel 2 - New UI',
// // 	build: 'developer-new-ANDROID-build-1',
// //   'name': 'UC000043 - Employee Manual Attendance created by Supervisor ',
...
//   return await searchInput.sendKeys('supervisortest@gmail.com');
// })
// .then(function() {
//   if (desiredCaps.platformName == 'iOS' || desiredCaps.platformName == 'ios' || desiredCaps.platformName == 'IOS')
//     return driver.waitForElementByXPath(
...
// .then(async function() {
//   if (desiredCaps.platformName == 'Android')
//     return await driver.waitForElementByAccessibilityId('presentcomments', asserters.isEnabled, 3000);
// })
// .then(async function(searchElement) {
