...
desiredCaps = {
  ...
  'browserstack.key' : 'htCqd4CJdqdyqeCnosDP',
	...
	name: 'UC000099 - Owner - Payroll and Payslip',
	 platformName: 'ios'
};
...
driver
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//ancestor::*[*[@text="01 November 2021 - 31 December 2021"]]', asserters.isEnabled, 4000);
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	})
