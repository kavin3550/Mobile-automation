...
desiredCaps.name = 'UC000035 - Owner - Flexi Checkin and Checkout resides in dashboard'
...
driver
	...
	.fin(function() {
		...
		try {
			console.log('Usecase Executed : UC000035');
			return driver.quit();
		} catch (e) {
			console.log('Usecase failed : UC000035');
			console.log(e);
		}
	})
	.done();
