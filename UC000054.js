...
desiredCaps.name= 'UC000054 - SUPERVISOR - Work From Home';
...
driver
	...
	.then(async function () {
		...
		return await driver.waitForElementByAccessibilityId(
		  ...
		  'super super'+day_string+' '+month+' '+year, asserters.isDisplayed
	...
	.then(async function(searchInput) {
		if(searchInput)
			return await searchInput.sendKeys('Chat by - super super');
	})
