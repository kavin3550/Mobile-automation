...
desiredCaps.name = 'UC000081 - Employee - Add Claim and Leadership Rejection'
...
.then(async function() {
  ...
  if (desiredCaps.platformName == 'iOS' || desiredCaps.platformName == 'ios' || desiredCaps.platformName == 'IOS')
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//android.widget.TextView[@text="Pending"]', asserters.isEnabled, 25000);
	})
	.then(async function(searchElement) {
	//	if(searchElement)
		return await searchElement.click();
