...
desiredCaps = {
  ...
  'browserstack.key' : 'htCqd4CJdqdyqeCnosDP',
	...
	name: 'UC000070 - Employee - Add Leave and Manager Rejection',
	 platformName: 'ios'
};
...
driver
	...
	.then(async function() {
		...
		return await driver.waitForElementByAccessibilityId('10 April 2022', asserters.isEnabled, 4000);
	})
	.then(async function(searchElement) {
		if(searchElement)
		return await searchElement.click();
	...
	// 		return await driver.waitForElementByXPath('//ancestor::*[*[@text="Manager test1"]]',asserters.isDisplayed && asserters.isEnabled,5000);
	// })
	// .then(async function(searchElement) {
	// 	return await searchElement.click();
	// })
	...
	.then(async function() {
		...
		else return await driver.waitForElementByAccessibilityId('Yogaraj M-10 Apr 2022to10 Apr 2022', asserters.isEnabled, 4000);
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	})
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//android.widget.TextView[@text="Reject"]', asserters.isEnabled, 4000);
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	})
