...
desiredCaps.name = 'UC000044 - Employee Manual Attendance and Supervisor Approval';
...
.then(async function(searchElement) {
  try{
    ...
    if (desiredCaps.platformName == 'iOS' || desiredCaps.platformName == 'ios' || desiredCaps.platformName == 'IOS') return await searchElement.click();
} catch (err) {}
})
...
.fin(function() { 
    ...
    try {
			console.log('Usecase Executed : UC000044');
			return driver.quit();
		} catch (e) {
			console.log('Usecase failed : UC000044');
			console.log(e);
		}
})
.done();