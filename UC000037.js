...
desiredCaps.name = 'UC000037 - Manager - Flexi Checkin and Checkout resides in dashboard';
...
driver
	...
	.fin(function() {
		...
		try {
			console.log('Usecase Executed : UC000037');
			return driver.quit();
		} catch (e) {
			console.log('Usecase failed : UC000037');
			console.log(e);
		}
	})
	.done();
