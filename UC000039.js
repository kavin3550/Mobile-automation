...
desiredCaps.name = 'UC000039 - Employee - Flexi Checkin and Checkout resides in dashboard';
...
driver
	...
	.fin(function() {
		...
		try {
			console.log('Usecase Executed : UC000039');
			return driver.quit();
		} catch (e) {
			console.log('Usecase failed : UC000039');
			console.log(e);
		}
	})
	.done();
