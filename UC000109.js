...
desiredCaps.name= 'UC000109 - OWNER - Work From Home with Leadership Chat';
	...
	.then(async function (searchElement) {
	  ...
	  .then(async function () {
		return await driver.waitForElementByAccessibilityId(
			...
			'Owner Test'+day_string+' '+month+' '+year, asserters.isDisplayed
			&& asserters.isEnabled, 4000);
	  })
	  .then(async function (searchElement) {
		return await searchElement.click();
	  ...
	  .fin(function() { 
		  ...
		  try {
				  console.log('Usecase Executed : UC000109');
				  return driver.quit();
			  } catch (e) {
				  console.log('Usecase failed : UC000109');
				  console.log(e);
			  }
	  })
	.done();
