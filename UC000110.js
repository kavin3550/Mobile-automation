...
desiredCaps.name= 'UC000110 - Employee - Add Leave and Supervisor Chat';
...
driver
	...
	.then(async function () {
	  ...
	  .then(async function(searchInput) {
		if(searchInput)
		  return await searchInput.sendKeys('Chat by - Supervisor');
	  })
	...
	.fin(function() {
	  ...
	  try {
		console.log('Usecase Executed : UC000110');
		return driver.quit();
	} catch (e) {
		console.log('Usecase failed : UC000110');
		console.log(e);
	}
	})
	.done();
