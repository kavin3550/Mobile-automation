...
desiredCaps = {
  ...
  'browserstack.key' : 'htCqd4CJdqdyqeCnosDP',
	...
	name: 'UC000092 - Employee - Add Deduction and Manager Approval',
...
driver
	...
	.then(async function() {
		...
		else return await driver.waitForElementByAccessibilityId('Yogaraj M-Advance-31 March 2022', asserters.isEnabled, 25000);
		//else return await driver.waitForElementByXPath('//android.view.ViewGroup[@content-desc="Yogaraj M-Advance-31 March 2022"]', asserters.isEnabled, 15000);
	})
	.then(async function(searchElement) {
		if(searchElement)
		{
	...
	// or //android.view.ViewGroup[@content-desc="Yogaraj M-Advance-31 March 2022"]
	.then(async function() {
		if (desiredCaps.platformName == 'iOS' || desiredCaps.platformName == 'ios' || desiredCaps.platformName == 'IOS')
			return await driver.waitForElementByXPath(
		...
		else return await driver.waitForElementByXPath('//android.widget.TextView[@text="Approve"]', asserters.isEnabled, 30000);
	})
	.then(async function(searchElement) {
		if(searchElement)
		return await searchElement.click();
