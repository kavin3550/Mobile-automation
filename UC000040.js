...
desiredCaps.name = 'UC000040 - Employee Manual Attendance created by Owner';
...
driver
	...
	// .then( function() {
	// 	//await driver.findElement(BY.label('CHART')).tap();
	...
	.then(async function() {
		try{
			if(enableScreenshot){
				console.log('Actionsheet - screenshot');
				await driver.takeScreenshot();
			}
		if (desiredCaps.platformName == 'Android')
			return await driver.waitForElementByAccessibilityId(
				...
				'//XCUIElementTypeTextField[@name="txtsearch"]',
				asserters.isDisplayed && asserters.isEnabled,
				4000
			);
		} catch (err) {}
	...
	.then(async function(searchInput) {
		try{
		if (desiredCaps.platformName == 'Android') 
			return await searchInput.sendKeys('yoga');
		else return await searchInput.sendKeys('yoga\n');
	} catch (err) {}
	})
	// .then(async function() {
	...
	.then(async function() {
		...
		if (desiredCaps.platformName == 'Android')
			return await driver.waitForElementByXPath(
				...
				'(//XCUIElementTypeOther[@name="Yogaraj M employee test"])[1]',
				asserters.isDisplayed && asserters.isEnabled,
				4000
			);
		} catch (err) {}
	...
	// 	if (desiredCaps.platformName == 'iOS' || desiredCaps.platformName == 'ios' || desiredCaps.platformName == 'IOS') 
	// 		return await driver.waitForElementByXPath(
	// 			'//XCUIElementTypeOther[@name="Calendar List Chart"]',
	// 			asserters.isDisplayed && asserters.isEnabled,
	// 			15000
	// 		);
	// })
	...
	// 	if (desiredCaps.platformName == 'iOS' || desiredCaps.platformName == 'ios' || desiredCaps.platformName == 'IOS') 
	// 		return await driver.waitForElementByXPath(
	// 			'(//XCUIElementTypeOther[@name="Tue"])[1]',
	// 			asserters.isDisplayed && asserters.isEnabled,
	// 			15000
	// 		);
	// })
	...
	// 	//return await driver.getLocation(searchElement,5000);
	// })
	...
	.then(async function() {
		try{
			if(enableScreenshot){
				console.log('Calendar - screenshot');
				await driver.takeScreenshot();
			}
		if (desiredCaps.platformName == 'Android') 	
			return await driver.waitForElementByXPath(
			'//*[@text="tabCalendarView" or @text="Calendar" or @text="CALENDAR"]',
			asserters.isDisplayed && asserters.isEnabled,
			10000
		);
	} catch (err) {}
	...
	.then(async function() {
		...
		if (desiredCaps.platformName == 'iOS' || desiredCaps.platformName == 'ios' || desiredCaps.platformName == 'IOS')
			return await driver.waitForElementByXPath(
				'(//XCUIElementTypeOther[@name="Absent"])[1]',
				asserters.isDisplayed && asserters.isEnabled,
				10000
			);
		else
			return await driver.waitForElementByXPath('//ancestor::*[*[@text="10"]]', asserters.isEnabled, 10000);
		} catch (err) {}
	})
	.then(async function(searchElement) {
		try{
	...
	.then(async function() {
		try{
			if(enableScreenshot){
				console.log('Mark update - screenshot');
				await driver.takeScreenshot();
			}
		if (desiredCaps.platformName == 'Android')
			return await driver.waitForElementByXPath('//ancestor::*[*[@text="Mark present" or @text="Mark update"]]', asserters.isEnabled, 2000);
		} catch (err) {}
	})
	.then(async function(searchElement) {
		try{
	...
	.then(async function(searchElement) {
		try{
			if(enableScreenshot){
				console.log('Comments - screenshot');
				await driver.takeScreenshot();
			}
	...
	.then(async function() {
		try{
		if (desiredCaps.platformName == 'Android')
			return await driver.waitForElementByAccessibilityId('btnupdate', asserters.isEnabled, 1000);
		} catch (err) {}
	})
	.then(async function(searchElement) {
		try{
	...
	.then(async function() {
		try{
		if (desiredCaps.platformName == 'Android')
			return await driver.waitForElementByAccessibilityId('btnOk', asserters.isEnabled, 1000);
		} catch (err) {}
	})
	.then(async function(searchElement) {
		try{
	...
	.fin(function() {
			...
			try {
				console.log('Usecase Executed : UC000040');
				return driver.quit();
			} catch (e) {
				console.log('Usecase failed : UC000040');
				console.log(e);
			}
	})
	.done();
