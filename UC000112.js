...
desiredCaps.name= 'UC000112 - MANAGER - Add Leave and Leadership Chat';
...
driver
	...
	.then(async function() {
		try{
		return await driver.waitForElementByXPath(
		'//ancestor::*[*[@text="Manager test1" or @text="Manager test1 " or @text="Manager Test1"]]',
		asserters.isEnabled,
		15000
		);
		} catch (err) {}
	...
	.then(async function() {
		...
		else return await driver.waitForElementByAccessibilityId('Manager Test'+day_string+' '+month+' '+year, asserters.isEnabled, 4000);
	} catch (err) {}
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	...
	.fin(function() {
	  ...
	  try {
		console.log('Usecase Executed : UC000112');
		return driver.quit();
	} catch (e) {
		console.log('Usecase failed : UC000112');
		console.log(e);
	}
	})
	.done();
