...
desiredCaps.name = 'UC000089 - Supervisor - Add Deduction and Leadership Rejection';
...
driver
	...
	.then(async function() {
		...
		else return await driver.waitForElementByXPath('//android.view.ViewGroup[@content-desc=\"super super'+day_string+' '+month+' '+year+'\"]', asserters.isEnabled, 15000);
	})
	.then(async function(searchElement) {
		if(searchElement)
		{
