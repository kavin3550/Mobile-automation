...
desiredCaps.name= 'UC000114 - OWNER - Add Leave and Leadership Chat';
...
driver
	...
	.then(async function() {
		...
		else return await driver.waitForElementByAccessibilityId('Owner Test'+day_string+' '+month+' '+year, asserters.isEnabled, 4000);
	} catch (err) {}
	})
	.then(async function(searchElement) {
		return await searchElement.click();
	...
	.fin(function() {
	  ...
	  try {
		console.log('Usecase Executed : UC000114');
		return driver.quit();
	} catch (e) {
		console.log('Usecase failed : UC000114');
		console.log(e);
	}
	})
	.done();
